...
namespace SuperStore2.Controllers
{
    public class CatagoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatID,CatName")] Catagory category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatID,CatName")] Catagory category)
        {
